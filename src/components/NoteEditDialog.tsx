    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <Dialog
          ...
          />
          <DialogContent 
            className='sm:max-w-2xl max-h-[80vh] overflow-hidden flex flex-col relative z-50'
            asChild>
            <motion.div
              initial={{ 
                opacity: 0, 
                ...
                <div className='flex-1 min-w-0'>
                  {isEditing ? (
                    <motion.input
                      ...
                      className='w-full text-lg font-semibold bg-transparent border-0 focus:ring-0 focus:outline-none text-gray-900 placeholder-gray-400 transition-all duration-200'
                  ...
                  <motion.div 
                    ...
                    {isEditing ? (
                      <motion.select
                        ...
                        className='px-2 py-1 text-xs border border-gray-300 rounded focus:ring-1 focus:ring-green-500 bg-white transition-all duration-200'
              ...
              <AnimatePresence mode="wait">
                {isEditing ? (
                  <motion.textarea
                    ...
                    className='w-full h-full min-h-[400px] p-4 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none bg-white transition-all duration-200'
                  ...
                  <motion.div 
                    ...
                    exit={{ opacity: 0, scale: 0.98, y: -10 }}
                    transition={{ duration: 0.3, ease: [0.16, 1, 0.3, 1] }}>
                    <div className='p-4 bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-lg border border-gray-200/50 shadow-sm'>
