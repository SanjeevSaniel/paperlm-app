...
export default function NotebookLMLanding() {
  ...
  return (
    <div
      ref={containerRef}
      className='min-h-screen bg-gradient-to-br from-purple-50/60 via-amber-50/50 to-orange-50/40'>
      {/* Header */}
      <motion.header
      ...
      <motion.section
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <motion.p
            ...
            Upload research papers, PDFs, and documents. Ask questions, get
            summaries, and discover insights through natural conversation with
            AI.
          </motion.p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <motion.div
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Interactive demos showing how PaperLM transforms document
              interaction
            </p>
          </motion.div>
              ...
              <div>
                <motion.div
                  ...
                  <p className='text-lg text-gray-600 mb-6'>
                    Drop any PDF, Word doc, or research paper. Our AI processes
                    and indexes your content in seconds, making it ready for
            ...
            <motion.div
              ...
              <div>
                <motion.div
                  ...
                  <p className='text-lg text-gray-600 mb-6'>
                    Let AI automatically extract key insights, generate
                    summaries, and organize your findings into actionable notes
      ...
      <section
        id='features'
        className='py-20 bg-gradient-to-br from-purple-50/30 via-amber-50/20 to-orange-50/30 relative overflow-hidden'>
        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
          <motion.div
            ...
            <p className='text-xl text-gray-600 max-w-2xl mx-auto'>
              Transform how you interact with documents through intelligent AI
              conversation
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  'PDFs, Word docs, research papers, and text files. Upload anything and start analyzing immediately.',
                color: 'amber',
                delay: 0.1,
              },
              {
                ...
                description:
                  'Ask questions in plain English. Get detailed answers with citations and contextual explanations.',
                color: 'orange',
                delay: 0.2,
              },
              {
                ...
                description:
                  'Discover key themes, generate summaries, and extract actionable insights from complex documents.',
                color: 'amber',
                delay: 0.3,
              },
            ].map((feature) => (
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div>
                <motion.div
                  ...
                  <p className='text-lg text-gray-600 mb-6'>
                    No more scrolling through endless pages. Ask specific
                    questions and get precise answers with source citations.
                  </p>
                  <div className='space-y-3'>
                    {[
          ...
          <div className='space-y-12'>
            <div className='flex items-start gap-6'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Drop your PDFs, research papers, or any text documents.
            ...
            <div className='flex items-start gap-6'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Use natural language to ask about content, request summaries,
            ...
            <div className='flex items-start gap-6'>
              ...
              <div>
                ...
                <p className='text-gray-600'>
                  Receive detailed, contextual responses based on your document
          ...
          <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-6 max-w-7xl mx-auto'>
            ...
            <motion.div
              ...
              <div className='mb-6'>
                ...
                <p className='text-gray-600 mt-2'>
                  Perfect for trying out PaperLM
                </p>
              </div>
            ...
            <motion.div
              ...
              <div className='mb-6'>
                ...
                <p className='text-gray-600 mt-2'>
                  For researchers and professionals • Cancel anytime
                </p>
              </div>
          ...
          <motion.div
            ...
            <div className='space-y-2'>
              <p className='text-sm text-gray-600'>
                All plans include data encryption, secure processing, and GDPR
                compliance
              </p>
              <p className='text-xs text-gray-500'>
                Pro: $5/month • Credits: $0.10/message • Cancel anytime • No
                setup fees
              </p>
            </div>
          </motion.div>
